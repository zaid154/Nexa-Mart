...
// One product the user has put in their cart. When the product sells in
// several configurations, `variant` holds the _id of the chosen one — the
// same product in two configurations is two separate cart lines.
